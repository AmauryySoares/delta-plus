...
import { getStudyAreasByUser, createStudyArea } from '@/lib/db'
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">
              Organize seus estudos por áreas e matérias
            </p>
          </div>
          ...
          >
              ...
              {PRESET_AREAS.map((area)=>(
                <button
                  ...
                  className={`p-3 rounded-lg border text-left ${
                    ...
                    ? 'border-delta-green-500'
                    : 'border-delta-navy-600'
                  }`}
                >
            ...
            <div className="flex gap-3">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-delta-navy-700 border border-delta-navy-600 rounded-lg text-white"
              />
